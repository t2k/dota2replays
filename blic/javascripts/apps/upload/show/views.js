...
(function() {
  ...
  define(['msgbus', 'marionette', 'apps/upload/show/templates'], function(msgBus, Marionette, Templates) {
    var _Layout, _options, _ref, _ref1, _ref2, _title;
    return {
      ...
      Options: _options = (function(_super) {
        ...
        function _options() {
          _ref1 = _options.__super__.constructor.apply(this, arguments);
          return _ref1;
        }
      ...
      Layout: _Layout = (function(_super) {
        ...
        function _Layout() {
          _ref2 = _Layout.__super__.constructor.apply(this, arguments);
          return _ref2;
        }
