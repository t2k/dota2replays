...
(function() {
  ...
  define(["backbone", "msgbus"], function(Backbone, msgBus) {
    var API, FUOptions, FileEntities, FileModel, _ref, _ref1, _ref2;
    FUOptions = (function(_super) {
      __extends(FUOptions, _super);

      function FUOptions() {
        _ref = FUOptions.__super__.constructor.apply(this, arguments);
        return _ref;
      }
    ...
    FileEntities = (function(_super) {
      ...
      function FileEntities() {
        ...
        _ref2 = FileEntities.__super__.constructor.apply(this, arguments);
        return _ref2;
      }
      ...
      FileEntities.prototype.initialize = function(models, options) {
        ...
        msgBus.reqres.setHandler("fu:addToQueue", function(input) {
          return _this.addFile(input);
        });
        msgBus.reqres.setHandler("fu:queue:empty", function() {
          return _this.reset();
        });
        return msgBus.reqres.setHandler("fu:queue:upload", function() {
